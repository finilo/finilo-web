...
export function TopMenu() {
  ...
  const menuImgVectorCancel =
    "https://www.figma.com/api/mcp/asset/5cd257f8-4de8-40fc-b44c-0cfd3aa1a9fa";
  const menuImgLogo =
    "https://www.figma.com/api/mcp/asset/863cb31d-3167-43dd-ad2e-ca310bf41255";
  const menuImgGroup22 =
    "https://www.figma.com/api/mcp/asset/479c2f0f-f976-4868-960a-64f332987c5b";
    ...
    <>
      ...
      {menuOpen ? (
        ...
        >
          {/* Grid background */}
          <div
            className="absolute inset-0 opacity-40 sm:opacity-100"
            style={{
          ...
          <div className="absolute left-1/2 top-[min(282px,22vh)] z-10 flex w-[min(681px,calc(100%-32px))] -translate-x-1/2 flex-col items-center gap-6 sm:gap-[27px]">
            ...
            <Link
              href="/contact"
              className="relative flex shrink-0 items-center justify-center p-[10px]"
            >
              <div
                className="relative flex shrink-0 flex-col justify-center text-center text-[clamp(2rem,10vw,4.2rem)] leading-[1.1] text-white not-italic min-[1512px]:text-[67.319px] min-[1512px]:leading-[0]"
                style={{ fontFamily: sf, fontWeight: 400 }}
